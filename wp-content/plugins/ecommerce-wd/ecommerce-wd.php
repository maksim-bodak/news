...
define('WD_E_VERSION', '1.2.1');
define('WD_E_DB_VERSION', '1.2.1');
...
function wde_options_panel() {
  ...
  add_submenu_page('wde_orders', __('Shippings', 'wde'), __('Shippings', 'wde'), 'manage_options', 'wde_shippingzones', 'wd_ecommerce');
