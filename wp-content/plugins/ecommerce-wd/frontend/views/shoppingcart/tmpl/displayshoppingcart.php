                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        ...
                        if (count($shipping_method->shipping_classes) > 1) {
                          ?>
                        <span class="wde_sipping_class_cont"><?php echo $shipping_classes_price ? __('Shipping', 'wde') . ':' : __('Free shipping', 'wde'); ?></span>
                          <?php
                        }
                        $free_shipping = FALSE;
                        foreach ($shipping_method->shipping_classes as $shipping_class) {
                  ...
                  <p>
                    <label for="count">
                      ...
                      <input type="number"
                             ...
                             min="1"
                             <?php echo $order_product_row->product_amount_in_stock > 0 ? '' : 'disabled="disabled"'; ?> />
                    </label>
                    <br />
