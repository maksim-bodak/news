...
class MWDControllerSubmissions {
	////////////////////////////////////////////////////////////////////////////////////////
	// Events                                                                             //
	////////////////////////////////////////////////////////////////////////////////////////
	////////////////////////////////////////////////////////////////////////////////////////
	...
	public function display() {
		$form_id = ((isset($_POST['form_id']) && esc_html($_POST['form_id']) != '') ? (int)esc_html($_POST['form_id']) : 0);
		require_once MWD_DIR . "/admin/models/MWDModelSubmissions.php";
		$model = new MWDModelSubmissions();

		require_once MWD_DIR . "/admin/views/MWDViewSubmissions.php";
		$view = new MWDViewSubmissions($model);
