...
class MWDControllerThemes{
	...
	public function display() {
		require_once MWD_DIR . "/admin/models/MWDModelThemes.php";
		$model = new MWDModelThemes();

		require_once MWD_DIR . "/admin/views/MWDViewThemes.php";
		$view = new MWDViewThemes($model);
		$view->display();
	}
