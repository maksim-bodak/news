...
class MWDViewManage_mwd {
	...
	public function display() {
		...
		<div class="mwd-user-manual">
			This section allows you to configure API
			<a target="_blank" href="https://web-dorado.com/wordpress-mailchimpwd-guid/configuring-api.html">Read More in User Manual</a>
		</div>
