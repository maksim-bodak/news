	...
	<div id="mwd-settings">
		<div id="mwd-settings-content" >
			...
			if($addons){
				...
				<!--	<div style="clear: both; margin-top: 15px;"> <h3 class="mwd-addon-subtitle"><?php echo $name?> </h3></div> -->
					<?php
						...
						<div class="mwd-add-on">
							...
							<?php if ( $addon['url'] !== '#' ) { ?>
								<a href="<?php echo $addon['url'] ?>"
								   target="_blank" class="mwd-addon"><span>GET THIS ADD ON</span></a>

							<?php } else { ?>
								<div class="mwd_coming_soon">
									<img
