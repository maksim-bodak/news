...
function wdwt_register_required_plugins() {
	...
	$config = array(
		...
		'strings'      => array(
			'page_title'                      => __( 'Install Recommended Plugins', "news-magazine" ),
			'menu_title'                      => __( 'Recommended Plugins', "news-magazine" ),
			'installing'                      => __( 'Installing Plugin: %s', "news-magazine" ), // %s = plugin name.
			...
			'activate'                        => __( 'Activate', "news-magazine" ),
			...
			'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', "news-magazine" ),  // %1$s = plugin name(s).
			'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', "news-magazine" ),  // %1$s = plugin name(s).
			'complete'                        => __( 'All plugins installed and activated successfully. %1$s', "news-magazine" ), // %s = dashboard link.
