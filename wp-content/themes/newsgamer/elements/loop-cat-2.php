<?php
    ...
    $first_image                = $first_image_attr->get_image_attr_cat02($mip_current_page->page_sidebar_template);
    ...
    while ( have_posts() ) : the_post();
        ...
        if ( $post_counter%2 == 0 ) {
            // display banner
            if ( $mip_current_page->cat_banner_show && ( $post_counter/2 == $mip_current_page->cat_banner_count ) ) {
        ...
        // $show_category = false, $shorten_text_chars = 150, $class = 'col-sm-6', $show_date = true, $show_comments = false, $show_author = false, $show_views = false
        echo mipthemeframework_get_string_prefix() . $post_article->formatArticleCat02($mip_current_page->page_template_show_category, $shorten_text_chars, 'col-sm-6', $mip_current_page->page_template_show_date, $mip_current_page->page_template_show_comments, $mip_current_page->page_template_show_author, $mip_current_page->page_template_show_views);
