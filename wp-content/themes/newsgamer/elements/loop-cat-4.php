<?php
    ...
    $first_image                = $first_image_attr->get_image_attr_cat04($mip_current_page->page_sidebar_template);
    ...
    while ( have_posts() ) : the_post();
        ...
        $post_article->article_post_date                = get_the_time(MIPTHEME_DATE_DEFAULT_SHORT);
        ...
        if ( $post_counter%4 == 0 ) {
            // display banner
            if ( $mip_current_page->cat_banner_show && ( $post_counter/4 == $mip_current_page->cat_banner_count ) ) {
        ...
        echo mipthemeframework_get_string_prefix() . $post_article->formatArticleCat02($mip_current_page->page_template_show_category, $shorten_text_chars, 'col-sm-3', $mip_current_page->page_template_show_date, $mip_current_page->page_template_show_comments, $mip_current_page->page_template_show_author, $mip_current_page->page_template_show_views);
