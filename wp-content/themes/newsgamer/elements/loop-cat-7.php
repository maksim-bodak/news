<?php
    ...
    while ( have_posts() ) : the_post();
        ...
        $post_article->article_content                  = ( empty( $post->post_excerpt ) ) ? get_the_content( esc_html__('Read more', 'Newsgamer') ) : $post->post_excerpt;
        ...
        $post_article->article_thumb = ( has_post_thumbnail() ) ? $att_img_src[0] : MipThemeFramework_Util::mp_set_dummy_img('470x320');
        ...
        echo mipthemeframework_get_string_prefix() . $post_article->formatArticleCat05('h3', $mip_current_page->page_template_show_category, 0, 'col-sm-6', $mip_current_page->page_template_show_date, $mip_current_page->page_template_show_comments, $mip_current_page->page_template_show_author, $mip_current_page->page_template_show_views);
