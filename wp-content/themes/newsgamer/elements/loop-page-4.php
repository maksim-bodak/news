...
<?php
    ...
    elseif ( has_post_thumbnail() ) {
        ...
        $featured_image_attr        = $featured_image->get_image_loop_page_4($mip_current_page->page_sidebar_template, $mip_current_page->page_image_full_height);
        ...
        echo    '<div class="head-image thumb-wrap relative">
                    '. get_the_post_thumbnail( $post->ID, $featured_image_attr[0], $img_attr ) .'
