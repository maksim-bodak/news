...
while ( $r->have_posts() ) :
    ...
    if ( $post_counter == 1 ) {
        ...
        $image                  = $image_attr->get_image_attr_top_grid_1('first'. $mip_top_grid->top_grid_full_width);
    ...
    } else if ( $post_counter > 3 ) {
        $image_attr             = new MipThemeFramework_Image();
        $image                  = $image_attr->get_image_attr_top_grid_1('second'. $mip_top_grid->top_grid_full_width);
