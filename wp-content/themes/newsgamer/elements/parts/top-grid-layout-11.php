...
while ( $r->have_posts() ) :
    ...
    if ( $post_counter == 1 ) {
        ...
        $image                  = $image_attr->get_image_attr_top_grid_11('first'. $mip_top_grid->top_grid_full_width);
        ...
        $output_left     .= $post_article->formatArticleOverlay('h2', $mip_top_grid->top_grid_show_category, $mip_top_grid->top_grid_show_date, $mip_top_grid->top_grid_show_comments, $mip_top_grid->top_grid_show_author, $mip_top_grid->top_grid_show_views, 0, $post_counter);
    } else if ( $post_counter == 2 ) {
        $image_attr             = new MipThemeFramework_Image();
        $image                  = $image_attr->get_image_attr_top_grid_11('second'. $mip_top_grid->top_grid_full_width);
        ...
        $output_mid     .= $post_article->formatArticleOverlay('h3', $mip_top_grid->top_grid_show_category, $mip_top_grid->top_grid_show_date, $mip_top_grid->top_grid_show_comments, $mip_top_grid->top_grid_show_author, $mip_top_grid->top_grid_show_views, 0, $post_counter);
    } else {
        $image_attr             = new MipThemeFramework_Image();
        $image                  = $image_attr->get_image_attr_top_grid_11('third'. $mip_top_grid->top_grid_full_width);
        ...
        $output_right     .= $post_article->formatArticleOverlay('h3', $mip_top_grid->top_grid_show_category, $mip_top_grid->top_grid_show_date, $mip_top_grid->top_grid_show_comments, $mip_top_grid->top_grid_show_author, $mip_top_grid->top_grid_show_views, 0, $post_counter);
    }

    $post_counter++;
endwhile;

echo    '<div class="col-md-6">'. $output_left .'</div>
        <div class="col-md-3">'. $output_mid .'</div>
        <div class="col-md-3">'. $output_right .'</div>';
