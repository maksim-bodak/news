...
while ( $r->have_posts() ) :
    ...
    if ( $post_counter < 4 ) {
        ...
        $image                  = $image_attr->get_image_attr_top_grid_3('second'. $mip_top_grid->top_grid_full_width);
        ...
        $image_attr             = new MipThemeFramework_Image();
        $image                  = $image_attr->get_image_attr_top_grid_3('first'. $mip_top_grid->top_grid_full_width);
