...
while ( $r->have_posts() ) :
    ...
    $image                  = $image_attr->get_image_attr_top_grid_8('first'. $mip_top_grid->top_grid_full_width);
    ...
    $output     .= '<div class="col-md-3">'. $post_article->formatArticleOverlay('h3', $mip_top_grid->top_grid_show_category, $mip_top_grid->top_grid_show_date, $mip_top_grid->top_grid_show_comments, $mip_top_grid->top_grid_show_author, $mip_top_grid->top_grid_show_views, 0, $post_counter) .'</div>';
